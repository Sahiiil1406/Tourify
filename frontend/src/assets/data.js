export const data = [
	{
		...
		description:
			"Provides medical services and emergency care for students and staff.",
		openTime: "9:10am",
		closeTime: "9:00pm",
		coordinates: {
			lat: 12.971598,
	...
	},
	{
		...
		description:
			"Olympic-sized swimming pool for students and staff. Perfect for fitness and relaxation.",
		openTime: "6:00am",
		closeTime: "6:00pm",
		coordinates: {
			lat: 12.97345,
	...
	},
	{
		...
		description:
			"Central library with a vast collection of books, journals, and study spaces.",
		openTime: "8:00am",
		closeTime: "9:00pm",
		coordinates: {
			lat: 12.9712,
		...
		reviews: [
			{
				user: "Ava Wilson",
				comment:
					"The library has a great selection of books and quiet study areas.",
				rating: 5,
			},
			{
				user: "Liam Brown",
	...
	},
	{
		...
		description:
			"Digital library with access to e-books, research papers, and online resources.",
		openTime: "8:00am",
		closeTime: "10:00pm",
		coordinates: {
			lat: 12.9713,
		...
		reviews: [
			{
				user: "Sophia Garcia",
				comment:
					"Perfect place for research, but sometimes the Wi-Fi can be slow.",
				rating: 4,
			},
			{
				user: "Jackson Miller",
	...
	},
	{
		...
		description:
			"Facilities for indoor and outdoor sports, including basketball, badminton, and table tennis.",
		openTime: "6:00am",
		closeTime: "9:00pm",
		coordinates: {
			lat: 12.9721,
		...
		reviews: [
			{
				...
				comment:
					"Good variety of sports facilities, but it gets busy in the evenings.",
				rating: 4,
			},
			{
				user: "Ethan Thomas",
	...
	},
	{
		...
		description:
			"Hub for student activities, events, and cultural programs. Includes a cafeteria and lounge area.",
		openTime: "8:00am",
		closeTime: "11:00pm",
		coordinates: {
			lat: 12.9718,
	...
	},
	{
		...
		description:
			"Scenic beach for relaxation, jogging, and enjoying sunsets. Popular among students.",
		openTime: "6:00am",
		closeTime: "7:00pm",
		coordinates: {
			lat: 12.969,
